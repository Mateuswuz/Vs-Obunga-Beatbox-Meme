...
function onCreate()
	...
	makeGraphic('rollordie', screenWidth / 2 + 30, screenHeight, 'ff0000')
	...
	addLuaText('h')
	setTextFont('h', 'ClearSans-Bold.ttf')
	makeLuaSprite('funnylittleguy', 'pause/funnylittleguy', 495, 0)
