                -- Script made by Washo789, please, if you use it or modify it, I would like you to give me credits, Modified by Melocoton!.
				
local xx = 2930; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local yy = 1830; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 2960; -- Same code as above, but for boyfriend left, right
local yy2 = 1870; -- Same code as above, but for boyfriend up, down
